...
public class TrelloControllerTest {
    ...
    private Badge createNewBadge() {
        return new Badge("votes", new AttachmentByType(new Trello("board", "card")));
    }
    ...
    public void shouldCreateTrelloCard() throws Exception {
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("323", "Test", "http://test.com", createNewBadge());
